 ...
 */
  const rightSideFn = {
    ...
    switchDarkMode: () => { // Switch Between Light And Dark Mode
      ...
      const _giscusFrame = document.querySelector('iframe.giscus-frame');
      if (nowMode === 'light') {
        activateDarkMode()
        saveToLocal.set('theme', 'dark', 2)
        _giscusFrame.src = _giscusFrame.src.replace(/&theme=\w*/, `&theme=dark`)
        GLOBAL_CONFIG.Snackbar !== undefined && btf.snackbarShow(GLOBAL_CONFIG.Snackbar.day_to_night)
      } else {
        activateLightMode()
        saveToLocal.set('theme', 'light', 2)
        _giscusFrame.src = _giscusFrame.src.replace(/&theme=\w*/, `&theme=light`)
